...
public class CommandControlDadoSS implements CommandExecutor {
    ...
    private void getUsage(String namePlayer) {
        ...
        Bukkit.getPlayerExact(namePlayer).sendMessage(ChatColor.DARK_PURPLE+"Plugin fatto da DIO ANATRA");
    }
}
